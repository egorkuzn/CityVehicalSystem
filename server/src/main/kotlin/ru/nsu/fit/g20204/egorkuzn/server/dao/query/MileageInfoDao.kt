...
import ru.nsu.fit.g20204.egorkuzn.server.model.entity.query.MileageInfoEntity
import java.sql.ResultSet

@Repository
class MileageInfoDao(@Autowired jdbcConfig: JdbcConfig) : AbstractQueryRunner<MileageInfoEntity>(jdbcConfig) {
