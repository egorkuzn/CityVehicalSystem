...
import ru.nsu.fit.g20204.egorkuzn.server.model.entity.WorkersHierarchyInfoEntity
import java.sql.ResultSet

@Repository
class WorkersHierarchyInfoDao(jdbcConfig: JdbcConfig): BaseDao<WorkersHierarchyInfoEntity>(jdbcConfig) {
